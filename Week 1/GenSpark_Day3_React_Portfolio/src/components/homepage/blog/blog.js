						...
						<div className='col-md-4'>
							<div className='card card-blog'>
								...
								<div className='card-body'>
									...
									<p className='card-description'>Proin eget tortor risus. Pellentesque in ipsum id orci porta dapibus. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi.</p>
								</div>
							...
							<div className='card card-blog'>
								...
								<div className='card-body'>
									...
									<p className='card-description'>
										Proin eget tortor risus. Pellentesque in ipsum id
										orci porta dapibus. Praesent sapien massa,
